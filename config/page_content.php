    ...
    'pages' => [
        'about' => [
            ...
            'fields' => [
                ...
                ['key' => 'stats_showroom_title', 'label' => 'Stats: Item 1 title', 'type' => 'text', 'placeholder' => 'Curated drops'],
                ['key' => 'stats_showroom_desc', 'label' => 'Stats: Item 1 description', 'type' => 'text', 'placeholder' => 'Focused selection, premium presentation'],
                ['key' => 'stats_delivery_title', 'label' => 'Stats: Item 2 title', 'type' => 'text', 'placeholder' => 'Careful delivery'],
                ['key' => 'stats_delivery_desc', 'label' => 'Stats: Item 2 description', 'type' => 'text', 'placeholder' => 'Packed with care, delivered with confidence'],
                ['key' => 'stats_quality_title', 'label' => 'Stats: Item 3 title', 'type' => 'text', 'placeholder' => 'Concierge support'],
                ['key' => 'stats_quality_desc', 'label' => 'Stats: Item 3 description', 'type' => 'text', 'placeholder' => 'Fast help via WhatsApp when needed'],
                ['key' => 'facilities_heading', 'label' => '"What we offer" heading', 'type' => 'text', 'placeholder' => 'What we offer'],
                ['key' => 'facilities_intro', 'label' => 'What we offer intro line', 'type' => 'textarea', 'rows' => 1, 'placeholder' => 'A premium selection built around clarity, confidence, and a smooth checkout experience.'],
        ...
        'contact' => [
            ...
            'fields' => [
                ...
                ['key' => 'form_intro_heading', 'label' => 'Form intro heading', 'type' => 'text', 'placeholder' => "Looking for a watch, perfume, or serum? We're here to help."],
        ...
        'faq' => [
            ...
            'fields' => [
                ...
                ['key' => 'hero_subtitle', 'label' => 'Subtitle', 'type' => 'textarea', 'rows' => 1, 'placeholder' => 'Common questions about ordering, delivery, and support.'],
            ],
        ],
    ],
];
